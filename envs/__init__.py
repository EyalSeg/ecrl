...
from envs.small_maze_deceptive import SmallMazeDeceptive, SmallMazeSparse
...
gym.envs.register(
    id="PointMazeSmallSparse-v0",
    entry_point="envs.step_limited_maze_env:StepLimitedMazeEnv",
    kwargs=dict(
        model_cls=PointEnv,
        maze_task=SmallMazeSparse,
        maze_size_scaling=SmallMazeSparse.MAZE_SIZE_SCALING.point,
        inner_reward_scaling=0,
        time_limit=500,
    )
)
...
gym.envs.register(
    id="AntMazeSmallSparse-v0",
    entry_point="envs.step_limited_maze_env:StepLimitedMazeEnv",
    kwargs=dict(
        model_cls=AntEnv,
        maze_task=SmallMazeSparse,
        maze_size_scaling=SmallMazeSparse.MAZE_SIZE_SCALING.ant,
        inner_reward_scaling=0,
        time_limit=750,
    )
)
